...
public class CategoryToolTipLayerSample extends SampleChart {

	public CategoryToolTipLayerSample(Activity activity, SampleInfo info,
                                      boolean useLegend) {
		super(activity, info, useLegend);

		CreateHorizontalCategorySeries(info.seriesClass, true);

		CategoryToolTipLayer layer = new CategoryToolTipLayer();
		
		layer.setTransitionDuration(500);
		layer.setUseInterpolation(true);
	...
	protected String getDescription() {
		return "This sample demonstrates the Category Tooltip Layer that displays grouped tooltips for series that use a category axis.";
	}
}