...
public class ChartCategoryItemHighlightLayerSample extends SampleChart {

	public ChartCategoryItemHighlightLayerSample(Activity activity,
			SampleInfo info, boolean useLegend) {
		super(activity, info, useLegend);

		CreateHorizontalCategorySeries(info.seriesClass, true);
		
		CategoryItemHighlightLayer layer = new CategoryItemHighlightLayer();
	...
	protected String getDescription() {
		return "This sample demonstrates the Category Item Highlight Layer that highlights items in a series that use a category axis by drawing a banded shape at their position.";
	}
}
