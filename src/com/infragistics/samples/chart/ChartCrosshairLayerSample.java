...
public class ChartCrosshairLayerSample extends SampleChart {

	public ChartCrosshairLayerSample(Activity activity, SampleInfo info,
			boolean useLegend) {
	...
	protected String getDescription() {
		return "The Crosshair Layer provides crossing lines that meet at the actual value of each series they are targeting. Layer's properties that can be configured are its color, thickness.";
	}
}
